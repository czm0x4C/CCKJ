 ...
 *
 */
#define SCCB_SCL_L    		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_RESET)
#define SCCB_SCL_H    		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_SET)
#define SCCB_SDA_L    		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,GPIO_PIN_RESET)
#define SCCB_SDA_H    		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_8,GPIO_PIN_SET)

#define SCCB_READ_SDA    	HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_8)
#define SCCB_ID_W   	    0X60  			//OV2640 ID for Write
#define SCCB_ID_R   	    0X61  			//OV2640 ID for Read

#define OV2640_PWDN         HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,GPIO_PIN_SET)
#define OV2640_PWUP         HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,GPIO_PIN_RESET)
#define OV2640_RST  	      HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,GPIO_PIN_RESET)
#define OV2640_RUN  	      HAL_GPIO_WritePin(GPIOD,GPIO_PIN_0,GPIO_PIN_SET)
