...
#line 21 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ioreq.c"
...
USBD_StatusTypeDef USBD_CtlSendStatus(USBD_HandleTypeDef *pdev)
{
  ...
  pdev->ep0_state = 0x04U;

   
  (void)USBD_LL_Transmit(pdev, 0x00U, 0, 0U);
