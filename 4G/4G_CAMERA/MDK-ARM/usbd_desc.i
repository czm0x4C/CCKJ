...
#line 23 "../USB_DEVICE/App/usbd_desc.c"
...
#line 24 "../USB_DEVICE/App/usbd_desc.c"
#line 25 "../USB_DEVICE/App/usbd_desc.c"
...
#line 72 "../USB_DEVICE/App/usbd_desc.c"
...
__align(4) uint8_t USBD_HS_DeviceDesc[0x12U]  =
{
  0x12,                        
  0x01U,        
  ...
  0x00,                        
  64U,            
  ((uint8_t)((1155) & 0x00FFU)),            
  ((uint8_t)(((1155) & 0xFF00U) >> 8U)),            
  ((uint8_t)((22336) & 0x00FFU)),         
  ((uint8_t)(((22336) & 0xFF00U) >> 8U)),         
  0x00,                        
  0x02,
  0x01U,            
  0x02U,        
...
#line 207 "../USB_DEVICE/App/usbd_desc.c"
...
__align(4) uint8_t USBD_LangIDDesc[0x04U]  =
{
     0x04U,
     0x03U,
     ((uint8_t)((1033) & 0x00FFU)),
     ((uint8_t)(((1033) & 0xFF00U) >> 8U))
};
...
__align(4) uint8_t USBD_StrDesc[512U] ;




__align(4) uint8_t USBD_StringSerial[0x1A]  = {
  0x1A,
  0x03U,
};
...
uint8_t * USBD_HS_ProductStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
  if(speed == 0)
  {
    USBD_GetString((uint8_t *)"STM32 Virtual ComPort", USBD_StrDesc, length);
  }
  else
  {
    USBD_GetString((uint8_t *)"STM32 Virtual ComPort", USBD_StrDesc, length);
...
#line 384 "../USB_DEVICE/App/usbd_desc.c"
...
static void Get_SerialNum(void)
{
  ...
  deviceserial0 = *(uint32_t *) (0x1FFF7A10UL);
  deviceserial1 = *(uint32_t *) (0x1FFF7A10UL + 0x4);
  deviceserial2 = *(uint32_t *) (0x1FFF7A10UL + 0x8);
