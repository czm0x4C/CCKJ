...
#line 126 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dcmi.c"
...
#line 215 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dcmi.c"
  ...
  hdcmi->Instance->CR &= ~((0x1UL << (5U)) | (0x1UL << (6U))  | (0x1UL << (7U))  | 0x00000400U |
                           0x00000800U  | 0x00000100U | 0x00000200U | (0x1UL << (3U))  |
                           (0x1UL << (4U)));
  hdcmi->Instance->CR |=  (uint32_t)(hdcmi->Init.SynchroMode | hdcmi->Init.CaptureRate |                                      hdcmi->Init.VSPolarity  | hdcmi->Init.HSPolarity  |                                      hdcmi->Init.PCKPolarity | hdcmi->Init.ExtendedDataMode |                                      hdcmi->Init.JPEGMode);




  if(hdcmi->Init.SynchroMode == ((uint32_t)(0x1UL << (4U))))
  {
    hdcmi->Instance->ESCR = (((uint32_t)hdcmi->Init.SyncroCode.FrameStartCode)    |
                             ((uint32_t)hdcmi->Init.SyncroCode.LineStartCode << (uint32_t)(8U))|
                             ((uint32_t)hdcmi->Init.SyncroCode.LineEndCode << (uint32_t)(16U)) |
                             ((uint32_t)hdcmi->Init.SyncroCode.FrameEndCode << (uint32_t)(24U)));
  }

   
  ((hdcmi)->Instance ->IER |= (((uint32_t)(0x1UL << (4U))) | ((uint32_t)(0x1UL << (3U))) | ((uint32_t)(0x1UL << (2U))) | ((uint32_t)(0x1UL << (1U)))));

   
  hdcmi->ErrorCode = 0x00000000U;
...
HAL_StatusTypeDef HAL_DCMI_DeInit(DCMI_HandleTypeDef *hdcmi)
{
#line 272 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dcmi.c"
  ...
  do{ (hdcmi)->Lock = HAL_UNLOCKED; }while (0U);
...
HAL_StatusTypeDef HAL_DCMI_Start_DMA(DCMI_HandleTypeDef* hdcmi, uint32_t DCMI_Mode, uint32_t pData, uint32_t Length)
{
  ...
  do{ if((hdcmi)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (hdcmi)->Lock = HAL_LOCKED; } }while (0U);

   
  hdcmi->State = HAL_DCMI_STATE_BUSY;
  
   
  ((hdcmi)->Instance ->CR |= (0x1UL << (14U)));

   
  hdcmi->Instance->CR &= ~((0x1UL << (1U)));
  ...
  hdcmi->DMA_Handle->XferAbortCallback = 0;
...
HAL_StatusTypeDef HAL_DCMI_Stop(DCMI_HandleTypeDef* hdcmi)
{
  volatile uint32_t count = SystemCoreClock / 14U;
  ...
  do
  {
    if (count-- == 0U)
    {
      ...
      hdcmi->ErrorCode |= 0x00000020U;

      status = HAL_TIMEOUT;
      break;
    }
  }
  while((hdcmi->Instance->CR & (0x1UL << (0U))) != 0U);
...
HAL_StatusTypeDef HAL_DCMI_Suspend(DCMI_HandleTypeDef* hdcmi)
{
  ...
  if(hdcmi->State == HAL_DCMI_STATE_BUSY)
  {
    ...
    while((hdcmi->Instance->CR & (0x1UL << (0U))) != 0);
  }    
...
void HAL_DCMI_IRQHandler(DCMI_HandleTypeDef *hdcmi)
{
  ...
  if((isr_value & ((uint32_t)(0x1UL << (2U)))) == ((uint32_t)(0x1UL << (2U))))
  {
     
    ((hdcmi)->Instance ->ICR = (((uint32_t)(0x1UL << (2U)))));

     
    hdcmi->ErrorCode |= 0x00000002U;
  ...
  if((isr_value & ((uint32_t)(0x1UL << (1U)))) == ((uint32_t)(0x1UL << (1U))))
  {
     
    ((hdcmi)->Instance ->ICR = (((uint32_t)(0x1UL << (1U)))));

     
    hdcmi->ErrorCode |= 0x00000001U;
  ...
  if((isr_value & ((uint32_t)(0x1UL << (4U)))) == ((uint32_t)(0x1UL << (4U))))
  {
     
    ((hdcmi)->Instance ->ICR = (((uint32_t)(0x1UL << (4U)))));
  ...
  if((isr_value & ((uint32_t)(0x1UL << (3U)))) == ((uint32_t)(0x1UL << (3U))))
  {
     
    ((hdcmi)->Instance ->ICR = (((uint32_t)(0x1UL << (3U)))));
  ...
  if((isr_value & ((uint32_t)(0x1UL << (0U)))) == ((uint32_t)(0x1UL << (0U))))
  {
     
    if((hdcmi->Instance->CR & (0x1UL << (1U))) == ((uint32_t)(0x1UL << (1U))))
    { 
    ...
    ((hdcmi)->Instance ->IER &= ~(((uint32_t)(0x1UL << (0U)))));
...
HAL_StatusTypeDef HAL_DCMI_ConfigCrop(DCMI_HandleTypeDef *hdcmi, uint32_t X0, uint32_t Y0, uint32_t XSize, uint32_t YSize)
{
  ...
  hdcmi->Instance->CWSIZER = (XSize | (YSize << (uint32_t)(16U)));
  hdcmi->Instance->CWSTRTR = (X0 | (Y0 << (uint32_t)(16U)));
...
HAL_StatusTypeDef HAL_DCMI_DisableCrop(DCMI_HandleTypeDef *hdcmi)
{
  ...
  hdcmi->Instance->CR &= ~(uint32_t)(0x1UL << (2U));
...
HAL_StatusTypeDef  HAL_DCMI_ConfigSyncUnmask(DCMI_HandleTypeDef *hdcmi, DCMI_SyncUnmaskTypeDef *SyncUnmask)
{
  ...
  hdcmi->Instance->ESUR = (((uint32_t)SyncUnmask->FrameStartUnmask) |                           ((uint32_t)SyncUnmask->LineStartUnmask << (8U))|                           ((uint32_t)SyncUnmask->LineEndUnmask << (16U))|                           ((uint32_t)SyncUnmask->FrameEndUnmask << (24U)));
...
#line 1052 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_dcmi.c"
...
static void DCMI_DMAXferCplt(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdcmi->XferCount != 0U)
  {
    ...
    tmp = ((hdcmi->DMA_Handle->Instance->CR) & (0x1UL << (19U)));
    ...
    else if((hdcmi->DMA_Handle->Instance->CR & (0x1UL << (19U))) == 0U)
    {
...
static void DCMI_DMAError(DMA_HandleTypeDef *hdma)
{
  ...
  if(hdcmi->DMA_Handle->ErrorCode != 0x00000002U)
  {
