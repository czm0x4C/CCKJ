...
#line 1 "..\\HARDWARE\\OV2640\\ov2640.h"
...
#line 2 "..\\HARDWARE\\OV2640\\ov2640.h"
...
#line 6 "..\\HARDWARE\\OV2640\\ov2640.h"
#line 1 "../Core/Inc/dcmi.h"
...
#line 7 "..\\HARDWARE\\OV2640\\ov2640.h"
#line 1 "../USB_DEVICE/App/usbd_cdc_if.h"
...
#line 1 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
#line 29 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
#line 52 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
#line 86 "../Middlewares/ST/STM32_USB_Device_Library/Class/CDC/Inc/usbd_cdc.h"
...
#line 31 "../USB_DEVICE/App/usbd_cdc_if.h"
...
#line 8 "..\\HARDWARE\\OV2640\\ov2640.h"
...
#line 81 "..\\HARDWARE\\OV2640\\ov2640.h"


#line 129 "..\\HARDWARE\\OV2640\\ov2640.h"




extern unsigned char getPicture;
...
#line 2 "..\\HARDWARE\\OV2640\\ov2640.c"
...
void SCCB_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0400)|((uint16_t)0x0800), GPIO_PIN_SET);
...
void SCCB_Start(void)
{
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100),GPIO_PIN_SET);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0200),GPIO_PIN_SET);

    Tickdelay = 12*10;while(Tickdelay--);
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100),GPIO_PIN_RESET);
...
uint8_t SCCB_WR_Byte(uint8_t dat)
{
	...
	for(j=0;j<8;j++)
	{
		if(dat&0x80)HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100),GPIO_PIN_SET);
		else HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0100),GPIO_PIN_RESET);
		dat<<=1;
	...
	Tickdelay = 12*10;while(Tickdelay--);
	if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100)))res=1;
	else res=0;
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0200),GPIO_PIN_RESET);
	SCCB_SDA_OUT();
	return res;
...
uint8_t SCCB_RD_Byte(void)
{
	...
	for(j=8;j>0;j--)
	{
	    ...
	    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)),((uint16_t)0x0200),GPIO_PIN_SET);
		temp=temp<<1;
		if(HAL_GPIO_ReadPin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100)))temp++;
...
void SCCB_Rst(void)
{
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0800),GPIO_PIN_RESET)	;
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0400),GPIO_PIN_RESET)	;
	HAL_Delay(5);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0400),GPIO_PIN_SET)	;
	HAL_Delay(5);
}
...
void OV2640_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0004)|((uint16_t)0x0008), GPIO_PIN_SET);
...
void OV2640_Init(void)
{
	...
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0002),GPIO_PIN_SET);
	HAL_Delay(100);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0002),GPIO_PIN_RESET);
	HAL_Delay(100);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0001),GPIO_PIN_RESET);
	HAL_Delay(100);
	HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0C00UL)),((uint16_t)0x0001),GPIO_PIN_SET);
	HAL_Delay(100);
	SCCB_WR_Reg(0xFF, 0x01);	
	...
	confirmOV2640_MID = SCCB_RD_Reg(0x1C);
	confirmOV2640_MID = confirmOV2640_MID << 8;
	confirmOV2640_MID = confirmOV2640_MID | SCCB_RD_Reg(0x1D);



	
	confirmOV2640_PID = SCCB_RD_Reg(0x0A);
	confirmOV2640_PID = confirmOV2640_PID << 8;
	confirmOV2640_PID = confirmOV2640_PID | SCCB_RD_Reg(0x0B);




	if((confirmOV2640_MID != 0X7FA2) && (confirmOV2640_PID != 0X2642))
	{
