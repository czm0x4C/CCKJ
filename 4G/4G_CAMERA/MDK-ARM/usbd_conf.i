...
#line 295 "../Drivers/CMSIS/Device/ST/STM32F4xx/Include/stm32f4xx.h"
...
#line 23 "../USB_DEVICE/Target/usbd_conf.c"
#line 24 "../USB_DEVICE/Target/usbd_conf.c"
...
#line 25 "../USB_DEVICE/Target/usbd_conf.c"
...
#line 26 "../USB_DEVICE/Target/usbd_conf.c"
...
#line 28 "../USB_DEVICE/Target/usbd_conf.c"
...
void HAL_PCD_MspInit(PCD_HandleTypeDef* pcdHandle)
{
  ...
  if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x40040000UL))
  {
    ...
    GPIO_InitStruct.Alternate = ((uint8_t)0x0C);
    HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), &GPIO_InitStruct);

     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (29U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (29U)))); (void)tmpreg; } while(0U);
...
void HAL_PCD_MspDeInit(PCD_HandleTypeDef* pcdHandle)
{
  if(pcdHandle->Instance==((USB_OTG_GlobalTypeDef *) 0x40040000UL))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR &= ~((0x1UL << (29U))));

    


 
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x4000)|((uint16_t)0x8000));
...

{
  ...
  if ( hpcd->Init.speed == 0U)
  {
    speed = USBD_SPEED_HIGH;
  }
  else if ( hpcd->Init.speed == 2U)
  {
...

{
  ...
  *(volatile uint32_t *)((uint32_t)((hpcd)->Instance) + 0xE00UL) |= (0x1UL << (0U));
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  hpcd_USB_OTG_HS.Instance = ((USB_OTG_GlobalTypeDef *) 0x40040000UL);
  hpcd_USB_OTG_HS.Init.dev_endpoints = 6;
  hpcd_USB_OTG_HS.Init.speed = 2U;
  hpcd_USB_OTG_HS.Init.dma_enable = DISABLE;
  hpcd_USB_OTG_HS.Init.phy_itface = 2U;
...
#line 366 "../USB_DEVICE/Target/usbd_conf.c"
...
#line 620 "../USB_DEVICE/Target/usbd_conf.c"
