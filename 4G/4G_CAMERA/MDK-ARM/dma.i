...
{ 
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) |= ((0x1UL << (22U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB1ENR) & ((0x1UL << (22U)))); (void)tmpreg; } while(0U);                                    
    do{ (&hdcmi)->DMA_Handle = &(hdma_dcmi); (hdma_dcmi). Parent = (&hdcmi); } while(0U);        
    ...
    hdma_dcmi.Init.Mode=((uint32_t)(0x1UL << (8U)));                         
    hdma_dcmi.Init.Priority=((uint32_t)(0x2UL << (16U)));                
    hdma_dcmi.Init.FIFOMode=((uint32_t)(0x1UL << (2U)));              
    hdma_dcmi.Init.FIFOThreshold=((uint32_t)(0x1UL << (0U))); 
    ...
    do{ (&hdma_dcmi)->Lock = HAL_UNLOCKED; }while (0U);

	HAL_DMA_Start(&hdma_dcmi,(unsigned int)&((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL))->DR,memaddr,memsize);
}
