...
void MX_TIM1_Init(void)
{
  ...
  htim1.Init.AutoReloadPreload = 0x00000000U;
  ...
  if (HAL_TIM_PWM_ConfigChannel(&htim1, &sConfigOC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void MX_TIM4_Init(void)
{
  ...
  sConfigOC.OCPolarity = 0x00000000U;
  sConfigOC.OCFastMode = 0x00000000U;
  if (HAL_TIM_PWM_ConfigChannel(&htim4, &sConfigOC, 0x00000000U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  if(tim_pwmHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0U);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  if(timHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)))
  {
  ...
  else if(timHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  if(tim_baseHandle->Instance==((TIM_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x0000UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB2ENR &= ~((0x1UL << (0U))));
...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  if(tim_pwmHandle->Instance==((TIM_TypeDef *) (0x40000000UL + 0x0800UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (2U))));
