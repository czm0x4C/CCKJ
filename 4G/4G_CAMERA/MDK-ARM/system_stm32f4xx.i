...
#line 49 "../Core/Src/system_stm32f4xx.c"
...
#line 112 "../Core/Src/system_stm32f4xx.c"
  ...
  switch (tmp)
  {
    ...
    case 0x08:   
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (12000000U / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
      }
      else
      {
...
#line 737 "../Core/Src/system_stm32f4xx.c"
