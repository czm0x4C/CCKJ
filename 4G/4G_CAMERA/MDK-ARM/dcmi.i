...
void MX_DCMI_Init(void)
{
  ...
  hdcmi.Instance = ((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL));
  hdcmi.Init.SynchroMode = 0x00000000U;
  hdcmi.Init.PCKPolarity = ((uint32_t)(0x1UL << (5U)));
  hdcmi.Init.VSPolarity = 0x00000000U;
  hdcmi.Init.HSPolarity = 0x00000000U;
  hdcmi.Init.CaptureRate = 0x00000000U;
  hdcmi.Init.ExtendedDataMode = 0x00000000U;
  hdcmi.Init.JPEGMode = ((uint32_t)(0x1UL << (3U)));
...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* dcmiHandle)
{
  ...
  if(dcmiHandle->Instance==((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL)))
  {
   

   
     
    do { volatile uint32_t tmpreg = 0x00U; ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0U);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0040);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000000U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x0D);
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0100)|((uint16_t)0x0200);
    GPIO_InitStruct.Mode = ((0x2UL << 0U) | (0x0UL << 4U));
    GPIO_InitStruct.Pull = 0x00000000U;
    GPIO_InitStruct.Speed = 0x00000000U;
    GPIO_InitStruct.Alternate = ((uint8_t)0x0D);
    ...
    hdma_dcmi.Instance = ((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL));
    hdma_dcmi.Init.Channel = 0x02000000U;
    hdma_dcmi.Init.Direction = 0x00000000U;
    hdma_dcmi.Init.PeriphInc = 0x00000000U;
    hdma_dcmi.Init.MemInc = ((uint32_t)(0x1UL << (10U)));
    hdma_dcmi.Init.PeriphDataAlignment = ((uint32_t)(0x2UL << (11U)));
    hdma_dcmi.Init.MemDataAlignment = ((uint32_t)(0x2UL << (13U)));
    hdma_dcmi.Init.Mode = 0x00000000U;
    hdma_dcmi.Init.Priority = 0x00000000U;
    hdma_dcmi.Init.FIFOMode = ((uint32_t)(0x1UL << (2U)));
    hdma_dcmi.Init.FIFOThreshold = ((uint32_t)(0x3UL << (0U)));
    hdma_dcmi.Init.MemBurst = 0x00000000U;
    hdma_dcmi.Init.PeriphBurst = 0x00000000U;
    if (HAL_DMA_Init(&hdma_dcmi) != HAL_OK)
    {
      Error_Handler();
    }

    do{ (dcmiHandle)->DMA_Handle = &(hdma_dcmi); (hdma_dcmi). Parent = (dcmiHandle); } while(0U);
...
void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef* dcmiHandle)
{
  ...
  if(dcmiHandle->Instance==((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->AHB2ENR &= ~((0x1UL << (0U))));
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x1000UL)), ((uint16_t)0x0010)|((uint16_t)0x0020)|((uint16_t)0x0040));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0000UL)), ((uint16_t)0x0010)|((uint16_t)0x0040));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x0040)|((uint16_t)0x0080)|((uint16_t)0x0100)|((uint16_t)0x0200));

    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0040)|((uint16_t)0x0080));
