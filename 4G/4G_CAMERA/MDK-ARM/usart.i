...
void MX_USART1_UART_Init(void)
{
  ...
  huart1.Init.HwFlowCtl = ((uint32_t)((0x1UL << (8U)) | (0x1UL << (9U))));
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  if(uartHandle->Instance==((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL)))
  {
    ...
    GPIO_InitStruct.Pin = ((uint16_t)0x0200)|((uint16_t)0x0400)|((uint16_t)0x0800)|((uint16_t)0x1000);
