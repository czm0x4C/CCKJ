...
#line 22 "../Core/Src/stm32f4xx_it.c"
#line 1 "../Core/Inc/stm32f4xx_it.h"
...
#line 23 "../Core/Src/stm32f4xx_it.c"
...
void HAL_DCMI_FrameEventCallback(DCMI_HandleTypeDef *hdcmi)
{
	((hdcmi)->Instance ->ICR = (((uint32_t)(0x1UL << (0U)))));

		if(jpeg_data_ok==0)	
		{
			((&hdma_dcmi)->Instance ->CR &= ~(0x1UL << (0U)));
			while(((DMA_Stream_TypeDef *) (((0x40000000UL + 0x00020000UL) + 0x6400UL) + 0x028UL))->CR & 0X01);	
			jpeg_data_len = (60 * 1024) - ((&hdma_dcmi)->Instance ->NDTR);
			jpeg_data_ok=1; 				
		}
		if(jpeg_data_ok==2)	
		{
			((&hdma_dcmi)->Instance ->NDTR = (uint16_t)((60 * 1024)));
			((&hdma_dcmi)->Instance ->CR |= (0x1UL << (0U))); 
			jpeg_data_ok=0;						
		}
