...
#line 22 "../Core/Src/main.c"
#line 1 "../Core/Inc/dma.h"
...
#line 23 "../Core/Src/main.c"
#line 1 "../Core/Inc/tim.h"
...
#line 1 "../USB_DEVICE/App/usb_device.h"
...
#line 31 "../USB_DEVICE/App/usb_device.h"
#line 32 "../USB_DEVICE/App/usb_device.h"
...
#line 33 "../USB_DEVICE/App/usb_device.h"
...
#line 26 "../Core/Src/main.c"
#line 1 "../Core/Inc/gpio.h"
...
unsigned char jpeg_data_ok = 0;
unsigned int jpeg_data_len = 0;

unsigned int dcmi_data_buff[(60 * 1024)]={0};
...
int main(void)
{
  ...
  MX_USB_DEVICE_Init();
	...
	HAL_DCMI_Init(&hdcmi);
	((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL))->IER=0x0;										

	((&hdcmi)->Instance ->IER |= ((0x1UL << (0U))));		
	((&hdcmi)->Instance ->CR |= (0x1UL << (14U)));						
	DCMI_DMA_Init((unsigned int)&dcmi_data_buff,(60 * 1024),((uint32_t)(0x2UL << (13U))),((uint32_t)(0x1UL << (10U))));
	((&hdma_dcmi)->Instance ->CR |= (0x1UL << (0U))); 	
	((DCMI_TypeDef *) ((0x40000000UL + 0x10000000UL) + 0x50000UL))->CR|=(0x1UL << (0U));    			
