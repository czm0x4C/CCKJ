...
#line 163 "../Middlewares/ST/STM32_USB_Device_Library/Core/Inc/usbd_core.h"
...
#line 21 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
#line 120 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
#line 175 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
#line 224 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[pdev->classId]->GetFSConfigDescriptor != 0)
  {
...
#line 364 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
#line 412 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[0] != 0)
  {
...
USBD_StatusTypeDef USBD_RunTestMode(USBD_HandleTypeDef *pdev)
{
#line 437 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
...
#line 475 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[0] != 0)
  {
...
#line 515 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
                                        ...
                                        uint8_t epnum, uint8_t *pdata)
{
  ...
  if (epnum == 0U)
  {
    ...
    if (pdev->ep0_state == 0x03U)
    {
      if (pep->rem_length > pep->maxpacket)
      {
        pep->rem_length -= pep->maxpacket;

        (void)USBD_CtlContinueRx(pdev, pdata, (((pep->rem_length) < (pep->maxpacket)) ? (pep->rem_length) : (pep->maxpacket)));
      }
      else
      {
        ...
        switch (pdev->request.bmRequest & 0x1FU)
        {
          ...
          case 0x01U:
            idx = USBD_CoreFindIF(pdev, ((uint8_t)((pdev->request . wIndex) & 0x00FFU)));
            break;

          case 0x02U:
            idx = USBD_CoreFindEP(pdev, ((uint8_t)((pdev->request . wIndex) & 0x00FFU)));
            break;
        ...
        if (idx < 1U)
        {
          ...
          {
            if (pdev->pClass[idx]->EP0_RxReady != 0)
            {
              pdev->classId = idx;
    ...
    {
#line 644 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
    }
  }
  else
  {
    ...
    if (((uint16_t)idx != 0xFFU) && (idx < 1U))
    {
       
      if (pdev->dev_state == 0x03U)
      {
        if (pdev->pClass[idx]->DataOut != 0)
        {
          pdev->classId = idx;
  ...
  if (epnum == 0U)
  {
    ...
    if (pdev->ep0_state == 0x02U)
    {
      if (pep->rem_length > pep->maxpacket)
      {
        ...
        (void)USBD_LL_PrepareReceive(pdev, 0U, 0, 0U);
      }
      else
      {
        ...
        {
          (void)USBD_CtlContinueSendData(pdev, 0, 0U);
    ...
    {
#line 738 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
    }
...
USBD_StatusTypeDef USBD_LL_Reset(USBD_HandleTypeDef *pdev)
{
  ...
  pdev->dev_state = 0x01U;
  pdev->ep0_state = 0x00U;
  pdev->dev_config = 0U;
  pdev->dev_remote_wakeup = 0U;
  pdev->dev_test_mode = 0U;

#line 814 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"

  if (pdev->pClass[0] != 0)
  {
    if (pdev->pClass[0]->DeInit != 0)
    {
  ...
  (void)USBD_LL_OpenEP(pdev, 0x00U, 0x00U, 64U);
  pdev->ep_out[0x00U & 0xFU].is_used = 1U;

  pdev->ep_out[0].maxpacket = 64U;

   
  (void)USBD_LL_OpenEP(pdev, 0x80U, 0x00U, 64U);
  pdev->ep_in[0x80U & 0xFU].is_used = 1U;

  pdev->ep_in[0].maxpacket = 64U;
...
USBD_StatusTypeDef USBD_LL_SOF(USBD_HandleTypeDef *pdev)
{
  ...
  if (pdev->dev_state == 0x03U)
  {
#line 918 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
    if (pdev->pClass[0] != 0)
    {
      if (pdev->pClass[0]->SOF != 0)
      {
                                           ...
                                           uint8_t epnum)
{
  ...
  if (pdev->dev_state == 0x03U)
  {
    if (pdev->pClass[pdev->classId]->IsoINIncomplete != 0)
    {
                                            ...
                                            uint8_t epnum)
{
  ...
  if (pdev->dev_state == 0x03U)
  {
    if (pdev->pClass[pdev->classId]->IsoOUTIncomplete != 0)
    {
...
#line 1027 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  if (pdev->pClass[0] != 0)
  {
...
uint8_t USBD_CoreFindIF(USBD_HandleTypeDef *pdev, uint8_t index)
{
#line 1072 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  (void)pdev;
  (void)index;
...
uint8_t USBD_CoreFindEP(USBD_HandleTypeDef *pdev, uint8_t index)
{
#line 1112 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
  (void)pdev;
  (void)index;
...
#line 1147 "../Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_core.c"
