...
#define SCCB_READ_SDA    	HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_7)
#define SCCB_ID_W   	    0X60  			//OV2640 ID for Write
#define SCCB_ID_R   	    0X61  			//OV2640 ID for Read

#define OV2640_PWDN         HAL_GPIO_WritePin(GPIOI,GPIO_PIN_11,GPIO_PIN_SET)
#define OV2640_PWUP         HAL_GPIO_WritePin(GPIOI,GPIO_PIN_11,GPIO_PIN_RESET)
#define OV2640_RST  	      HAL_GPIO_WritePin(GPIOI,GPIO_PIN_10,GPIO_PIN_RESET)
#define OV2640_RUN  	      HAL_GPIO_WritePin(GPIOI,GPIO_PIN_10,GPIO_PIN_SET)
...
#define OV2640_INIT_OK 		(0x00)
#define OV2640_INIT_FAIL	(0xFF)
