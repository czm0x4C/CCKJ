...
private slots:
    ...
    void on_testModePushButton_clicked();

    void on_takePictureTestModePushButton_clicked();

    void on_openMotoTestModePushButton_clicked();

    void on_binDownLoadPushButton_clicked();
...
signals:
    ...
    void sendBinFileData_signal(QByteArray data);
